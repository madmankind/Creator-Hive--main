        ...
        >
          ...
          >
            <div className="relative flex-1 max-w-md">
              <Search size={15} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: feyTokens.colors.text.muted }} />
              <input
                autoFocus
                type="text"
                ...
                style={{ borderColor: "rgba(255,255,255,0.10)", color: feyTokens.colors.text.primary }}
              />
            </div>
            ...
            <button
              ...
              style={{ width: "36px", height: "36px", border: "1px solid rgba(255,255,255,0.10)", color: feyTokens.colors.text.muted }}
            >
              <X size={16} />
            </button>
          </div>
            ...
            >
              <div className="flex flex-1 gap-2 overflow-x-auto scrollbar-hide items-center">
                {selectedTalents.map((t) => (
                  ...
                  >
                    <div className="h-7 w-7 rounded-full flex items-center justify-center text-[10px] font-medium" style={{ background: "rgba(255,255,255,0.1)" }}>
                      {t.name.charAt(0)}
                    </div>
                    <span className="text-[11px] max-w-[80px] truncate" style={{ color: feyTokens.colors.text.primary }}>
                      {t.name}
                    </span>
                    <button onClick={() => removeTalent(t.id)} className="p-0.5 rounded hover:bg-white/10 transition" style={{ color: feyTokens.colors.text.muted }}>
                      <X size={12} />
                    </button>
                  </div>
                ))}
        ...
        {profileTalent && (
          <div className="p-6 space-y-5">
            {profileTalent.headline && (
              <p className="text-[13px]" style={{ color: feyTokens.colors.text.secondary }}>{profileTalent.headline}</p>
            )}
            {profileTalent.bio && (
              <p className="text-[13px]" style={{ color: feyTokens.colors.text.secondary }}>{profileTalent.bio}</p>
            )}
            <button
              onClick={() => { addTalent(profileTalent); setProfileOpen(false); setProfileTalent(null); }}
