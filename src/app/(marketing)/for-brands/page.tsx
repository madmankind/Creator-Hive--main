  ...
  return (
    <main>
      <section className="container py-20">
        <motion.h1 initial={{opacity:0,y:12}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:0.5}} className="text-4xl md:text-5xl font-extrabold text-gradient">Run creator projects on rails.</motion.h1>
      ...
      <section className="container grid md:grid-cols-3 gap-6 pb-20">
        {[
          ["Budget Tracking","Milestones, escrow, approvals"],
          ["Multi-freelancer","Coordinate shoots, edits, talent"],
          ["Compliance","Invoices with VAT-ready data"],
        ].map(([t,d])=> (
