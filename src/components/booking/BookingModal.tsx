...
export function BookingModal({ open, onClose, talents, onViewPod }: BookingModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store campaignId if returned (when talent is selected, campaign is created)
                ...
                >
                  ...
                  <div className="mt-8 flex justify-center gap-3">
                    ...
                    <button
                      ...
                      onClick={() => {
                        onClose();
                        // Redirect to specific campaign if created, otherwise to campaigns list
                        if (campaignId) {
                          router.push(`/dashboard/campaigns/${campaignId}?mode=manage`);
                        } else {
                    ...
                    >
                      {campaignId ? "Go to campaign" : "Go to campaign management"}
                    </button>
                  </div>
                </motion.div>
              )}
